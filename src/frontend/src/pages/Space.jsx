    ...
    <div className="space">
        ...
        <div className="space-wrapper-text space-passage-1">
            ...
            <div>
                ...
                <p>Unser Sonnensystem ist ein System, das die Sonne, acht Planeten, zahlreiche Zwergplaneten, Monde und andere Himmelskörper umfasst. Die Sonne ist der Mittelpunkt des Sonnensystems und übt eine gravitative Anziehungskraft auf die um sie umkreisenden Objekte aus. Jeder Planet hat seine eigenen einzigartigen Eigenschaften, Umlaufbahnen und Monde. Um sich die Planeten unseres Sonnensystems zu merken, hilft folgender Spruch: “<span onMouseEnter={e => e.target.innerHTML = "<b>Merkur</b>"} onMouseLeave={e => e.target.innerHTML ="<b>M</b>ein"}><b>M</b>ein</span> <span onMouseEnter={e => e.target.innerHTML = "<b>Venus</b>"} onMouseLeave={e => e.target.innerHTML ="<b>V</b>ater"}><b>V</b>ater</span> <span onMouseEnter={e => e.target.innerHTML = "<b>Erde</b>"} onMouseLeave={e => e.target.innerHTML ="<b>E</b>rklärt"}><b>E</b>rklärt</span> <span onMouseEnter={e => e.target.innerHTML = "<b>Mars</b>"} onMouseLeave={e => e.target.innerHTML ="<b>M</b>ir"}><b>M</b>ir</span> <span onMouseEnter={e => e.target.innerHTML = "<b>Jupiter</b>"} onMouseLeave={e => e.target.innerHTML ="<b>J</b>eden"}><b>J</b>eden</span> <span onMouseEnter={e => e.target.innerHTML = "<b>Saturn</b>"} onMouseLeave={e => e.target.innerHTML ="<b>S</b>onntag"}><b>S</b>onntag</span> <span onMouseEnter={e => e.target.innerHTML = "<b>Uranus</b>"} onMouseLeave={e => e.target.innerHTML ="<b>U</b>nseren"}><b>U</b>nseren</span> <span onMouseEnter={e => e.target.innerHTML = "<b>Neptun</b>"} onMouseLeave={e => e.target.innerHTML ="<b>N</b>achthimmel"}><b>N</b>achthimmel</span>”</p>
            </div>
